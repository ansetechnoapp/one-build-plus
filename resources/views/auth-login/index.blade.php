                        ...
                        <div class="grid grid-cols-1">
                            ...
                            <div class="flex justify-between mb-4">
                                <div class="inline-flex items-center">
                                    ...
                                    <label class="form-check-label text-slate-400" for="RememberMe">Se souvenir de
                                        moi</label>
                                </div>

                                <p class="text-slate-400 mb-0"><a href="{{ route('auth-re-password') }}"
                            ...
                            <div class="text-center">
                                <span class="text-slate-400 me-2">vous n'avez pas de compte </span> <a href="sign-up" class="text-black dark:text-white font-bold">Inscription</a>
                            </div>
