                ...
                <div class="container-fluid">
                    ...
                    @isset($issetcomment)
                        <div class="container-xl px-4 mt-n10 mb-4">
                            <div class="card mb-4">
                                <div class="card-header">Votre avis</div>
                                                ...
                                                <div class="col-xxl-6 col-xl-8">
                                                    ...
                                                    <form action="{{ route('dashboard.save.commentUser') }}" method="POST"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea class="form-control" name="message" id="" cols="30" rows="10" placeholder="message"
                                                                required></textarea>
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <button class="btn btn-primary"
                                                                type="submit"{{--  disabled --}}>Enrégistrer</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
