            ...
            <div class="flex justify-center">
                <div
                    ...
                    <div class="text-center">
                        <h5 class="my-6 text-xl font-semibold">S'il vous plait, veuillez bien consulter votre courriel
                            electronique <br>
                            a l'addresse @isset($email)
                                ({{ $email }})
                            @endisset <br>
                            pour modifier votre mots de passe <br>
                            <br>
                        </h5>
