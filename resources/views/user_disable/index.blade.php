            ...
            <div class="flex justify-center">
                <div
                    ...
                    <div class="text-center">
                        <h5 class="my-6 text-xl font-semibold">Votre Compte a été Désactiver,<br><br>
                            Veuillez Nous Contactez Pour Plus D'information <br>
                        </h5>
                    </div>
                    <div class="text-center">
                        <a href="{{ route('home') }}" class="text-black dark:text-white font-bold">Retour a La Page
                            D'accueil</a>
                    </div>
