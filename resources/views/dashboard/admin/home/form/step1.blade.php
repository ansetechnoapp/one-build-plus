                ...
                <div class="container-fluid">
                    ...
                    <div class="container-xl px-4 mt-n10 mb-4">
                        <nav class="nav nav-borders">
                            <a class="nav-link active ms-0" href="{{ route('admin.dashboard.admin') }}">Enrégistrement
                                des
                                biens immobiliers</a>

                            <a class="nav-link"
                                href="{{ route('admin.dashboard.admin.Rental_management') }}">Enrégistrement
                                des biens locatif</a>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xxl-6 col-xl-8">
                                                ...
                                                @if (!isset($allprodupdate))
                                                    <form action="{{ route('admin.form.save.prod.step1') }}"
                                                        method="POST" enctype="multipart/form-data"
                                                        onsubmit="return checkPrices()">
                                                        @csrf
                                                        <div class="mb-3">
                                                            ...
                                                            <input class="form-control" id="inputaddress" type="text"
                                                                placeholder="entrer l'addresse de la propiété"
                                                                name="address"
                                                                value="{{ Session::get('stp1_address') }}" required>
                                                        ...
                                                        <div class="row gx-3">
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input class="form-control"
                                                                    ...
                                                                    placeholder="Entrer le nom du propriétaire ou le nom de la propriété"
                                                                    name="landOwner_propertyName"
                                                                    value="{{ Session::get('stp1_landOwner_propertyName') }}"
                                                                    required>
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input class="form-control" id="inputarea"
                                                                    ...
                                                                    name="area"
                                                                    value="{{ Session::get('stp1_area') }}" required>
                                                                @if ($errors->has('area'))
                                                                    <div class="alert alert-danger">
                                                    ...
                                                    <form action="{{ route('admin.form.save.prod.step1') }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="hidden" value="{{ $allprodupdate->id }}"
                                                                name="prod_id">
                                                            <label class="small mb-1" for="inputaddress">Entrer les
                                                                détaille sur la localisation de la propiété</label>
                                                            <input class="form-control" id="inputaddress"
                                                                type="text"value="{{ $allprodupdate->address }}"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="status"
                                                                id="">
                                                                <option value="{{ $allprodupdate->status }}"selected>
                                                                    {{ $allprodupdate->status }}
                                                                </option>
                                                                <option value="disponible">Disponible</option>
                                                                <option value="vendu">Vendu</option>
                                                            </select>
