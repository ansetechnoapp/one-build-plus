                ...
                <div class="flex justify-center">
                    <div class="max-w-[400px] w-full m-auto p-6 bg-white dark:bg-slate-900 shadow-md dark:shadow-gray-700 rounded-md">
                        ...
                        <div class="grid grid-cols-1">
                            <p class="text-slate-400 mb-6">Veuillez saisir votre adresse électronique. Vous recevrez un lien pour créer un nouveau mot de passe par courriel.</p>
                            <form class="ltr:text-left rtl:text-right" action="{{route('password.updateSendEmail')}}" method="POST">
                                @csrf
                                <div class="grid grid-cols-1">
                                    <div class="mb-4">
                                    ...
                                    <div class="text-center">
                                        <span class="text-slate-400 me-2">Mémoriser votre mot de passe ? </span>
                                        <a href="{{route('auth-login')}}" class="text-black dark:text-white font-bold">Se connecter</a>
                                    </div>
                                </div>
                            </form>
                        </div>
