...
<!-- Mirrored from shreethemes.in/hously/layouts/blog-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 15:53:47 GMT -->
<head>
        <meta charset="UTF-8" />
                        ...
                        <div class="grid lg:grid-cols-2 grid-cols-1 gap-[30px]">
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/1.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Residential</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        <div class="flex justify-between mb-4">
                                            <span class="text-slate-400 text-sm"><i class="uil uil-calendar-alt text-slate-900 dark:text-white me-2"></i>3rd March, 2023</span>
                                            <span class="text-slate-400 text-sm ms-3"><i class="uil uil-clock text-slate-900 dark:text-white me-2"></i>5 min read</span>
                                        </div>
        
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">Skills That You Can Learn In The Real Estate Market</a>
                                        
                                        <div class="mt-3">
                                            <a href="blog-detail.html" class="btn btn-link hover:text-green-600 after:bg-green-600 duration-500 ease-in-out">Read More <i class="uil uil-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/2.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Land</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">Learn The Truth About Real Estate Industry</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/3.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Commercial</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">10 Quick Tips About Business Development</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/4.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Industrial</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">14 Common Misconceptions About Business Development</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/5.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Investment</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">10 Things Your Competitors Can Teach You About Real Estate</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/6.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Residential</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">Why We Love Real Estate</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/7.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Land</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">110 Quick Tips About Real Estate</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/8.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Commercial</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">15 Best Blogs To Follow About Real Estate</a>
                            ...
                            <div class="group relative h-fit hover:-mt-[5px] overflow-hidden bg-white dark:bg-slate-900 rounded-xl shadow dark:shadow-gray-700 transition-all duration-500">
                                <div class="relative overflow-hidden">
                                    <img src="assets/images/property/9.jpg" class="" alt="">
                                    <div class="absolute end-4 top-4">
                                        <span class="bg-green-600 text-white text-[14px] px-2.5 py-1 font-medium rounded-full h-5">Industrial</span>
                                    </div>
                                </div>
                                ...
                                <div class="relative p-6">
                                    <div class="">
                                        ...
                                        <a href="blog-detail.html" class="title text-xl font-medium hover:text-green-600 duration-500 ease-in-out">Using Banner Stands To Increase Trade Show Traffic</a>
