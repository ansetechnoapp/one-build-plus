                    ...
                    <div class="{{-- container-xl  --}}px-4 mt-n10 mb-4">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="{{ route('property_detail', ['id' => $post->id, 'price' => $post->price]) }}"
                                                        ...
                                                        style="background-color: rgb(14 165 233);margin: 5px;"><img
                                                            src="{{ $sub_path_admin }}assets/icons8-eye-96.png" alt="voir" width="30"
                                                            height=25></a>
                                                    <a href="{{ route('admin.dashboard.admin', ['id' => $post->id]) }}"
                                                        class="badge text-dark"
                                                        style="background-color: rgb(14 165 233);margin: 5px;"><img
                                                            src="{{ $sub_path_admin }}assets/icons8-edit-100.png" alt="modifier" width="30"
                                                            height=25></a>
                                                </td>
                                            </tr>
                                        @endforeach
                        ...
                        <div
                            style="display: flex;
                                    ...
                                    align-items: center;
                                    margin: 20px;">
                            <a href="{{ route('admin.list_prod', ['page' => '1']) }}" class="btn-act1">1</a>
