...
<!-- Mirrored from shreethemes.in/hously/layouts/index-five.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 15:52:22 GMT -->
<head>
        <meta charset="UTF-8" />
            ...
            <div class="container">
                <div class="grid grid-cols-1">
                    ...
                    <div class="relative -mt-[25px]">
                        <img src="assets/images/bg/05.jpg" class="rounded-xl shadow-md dark:shadow-gray-700" alt="">
                        <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                            <a href="#!" data-type="youtube" data-id="yba7hPeTSjk" class="lightbox h-20 w-20 rounded-full shadow-md dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-green-600">
...
<!-- Mirrored from shreethemes.in/hously/layouts/index-five.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 03 Jul 2023 15:52:24 GMT -->
</html>