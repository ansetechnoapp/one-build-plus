                    ...
                    <form class="ltr:text-left rtl:text-right" method="POST" action="{{ route('save.user') }}">
                        ...
                        <div class="grid grid-cols-1">
                            <div class="mb-4">
                                ...
                                <input id="LoginPassword" name="lastName" required type="text" class="form-input mt-3" placeholder="Nom"  required>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                <button class="btn bg-red-600 rounded-md w-full" type="submit">S'inscrire</button>
                            </div>
