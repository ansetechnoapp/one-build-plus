    ...
    class update extends Controller
{
    ...
    public function show(Request $request)
    {
        ...
        $query = prod::where('id', $id)
            ->first();
        return view('dashboard.admin.upadate_product.index', ['allprodupdate' => $query]);
    }
    ...
    public function updateprod(Request $request)
    {
        ...
        $rules = [
            ...
            'img1' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2060',
            'img2' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2060',
            'img3' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2060',
            'img4' => 'nullable|image|mimes:jpeg,png,jpg,gif|max:2060',
