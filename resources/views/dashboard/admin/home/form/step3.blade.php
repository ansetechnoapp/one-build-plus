                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-xxl-6 col-xl-8">
                                                ...
                                                @if (!isset($allprodupdate))
                                                    <form action="{{ route('admin.form.save.prod.step3') }}" method="POST"
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <a class="btn btn-primary"
                                                                href="{{ route('admin.form.view.prod.step2') }}">précédant</a>
                                                ...
                                                @if (isset($allprodupdate))
                                                    <form action="{{ route('admin.form.save.prod.step3') }}" method="POST"
                                                        ...
                                                        <hr class="my-4">
                                                        <div class="d-flex justify-content-between">
                                                            <a class="btn btn-primary" href="{{ route('admin.form.view.prod.step2', ['id' => $allprodupdate->id]) }}">précédant</a>
                                                            <button class="btn btn-primary" type="submit"
                                                                id="submitBtn">Valider</button>
                                                        </div>
                                                    </form>
